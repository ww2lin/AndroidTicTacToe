...
public class Model extends Observable implements ComputerCallBack{	
	...
	public void newGame(){
		...
		if(Util.STARTING_PIECE == Util.X_INDEX) setStartingX();
		else setStartingO();
	}
	...
	public void updateNameChange() {
		updateGameState(GameState.NAME_CHANGE);
	}
	...
	public void boardSizeSlider(int value) {
	...
	public void BoardWiningSlider(int value) {
		//if (getState().getState() == GameState.SELECTING_PLAYER || getState().getState() == GameState.SELECTED_PLAYER){
			winConstraint = value;
		//}
	...
	public int getBoardPiece(int i, int j){
